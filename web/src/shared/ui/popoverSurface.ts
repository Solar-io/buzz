...
/**
 * Shared surface, motion and shadow constants for every floating panel —
 * popovers, dropdown menus, context menus and their submenus.
 *
 * Ported verbatim from the desktop client's shared/ui/popoverSurface.ts. These
 * live in one module on purpose: copying the values inline into each primitive
 * is exactly how the desktop and web surfaces drifted apart in the first place.
 */
