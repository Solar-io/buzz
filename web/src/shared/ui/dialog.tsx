...
// Ported from the desktop client's shared/ui/dialog.tsx with one deliberate
// divergence: desktop's `surface="textured"` nine-slice powder card (and its
// card-texture.css / baked PNG assets) is not ported to web. `default` and
// `none` behave exactly as they do on desktop.
