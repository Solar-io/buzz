...
// Ported from the desktop client's shared/ui/button.tsx. Keep the variant and
// size strings in step with it: the two clients are deliberately decoupled at
// the module level, so the only thing holding them together is this recipe.
