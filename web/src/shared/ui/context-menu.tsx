// Ported verbatim from the desktop client's shared/ui/context-menu.tsx.
//
// This REPLACES web's hand-rolled shared/ui/ContextMenu.tsx (a fixed-position
// div with no submenus, separators, keyboard navigation, or collision
// handling, and destructive items hardcoded to `text-red-400` instead of the
// `text-destructive` token). The two files coexist until the one consumer,
// features/sidebar/ui/SidebarNavButton.tsx, is migrated; the filenames do not
// collide on a case-insensitive filesystem because they differ by a hyphen,
// not only by case (`contextmenu.tsx` != `context-menu.tsx`).
