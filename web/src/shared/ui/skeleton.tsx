...
// Ported from the desktop client's shared/ui/skeleton.tsx. The `t-skel*` /
// `is-pulsing` class contract lives in the colocated skeleton.css rather than in
// web's globals.css — see the header comment there.
